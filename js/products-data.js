/* ============================================================
   PRODUCTS DATA
   Nguồn dữ liệu trung tâm cho toàn bộ trang Sản phẩm.
   Mỗi sản phẩm: id, name, brand, category, price, oldPrice,
   rating, reviews, emoji (thay cho ảnh), gradient (màu nền ảnh),
   badge, desc, specs (thông số kỹ thuật hiển thị ở modal).
   ============================================================ */

const PRODUCTS = [
    {
        id: 1, name: "iPhone 17 Pro Max", brand: "Apple", category: "phone",
        price: 34990000, oldPrice: 38990000, rating: 5, reviews: 128,
        emoji: "📱", gradient: "linear-gradient(135deg,#1a1a2e,#16213e)", badge: "new",
    ...
    },
    {
        ...
        price: 67990000, oldPrice: 79990000, rating: 5, reviews: 94,
        emoji: "💻", gradient: "linear-gradient(135deg,#0f2027,#203a43)", badge: "sale",
    ...
    },
    {
        ...
        price: 8490000, oldPrice: 9990000, rating: 5, reviews: 207,
        emoji: "🎧", gradient: "linear-gradient(135deg,#1a0533,#2d1b69)", badge: "",
    ...
    },
    {
        ...
        price: 22990000, oldPrice: 0, rating: 4, reviews: 56,
        emoji: "⌚", gradient: "linear-gradient(135deg,#0d1117,#1a1f2e)", badge: "hot",
    ...
    },
    {
        ...
        price: 31990000, oldPrice: 35990000, rating: 5, reviews: 183,
        emoji: "📱", gradient: "linear-gradient(135deg,#0a192f,#112240)", badge: "new",
    ...
    },
    {
        ...
        price: 89990000, oldPrice: 0, rating: 5, reviews: 72,
        emoji: "🎮", gradient: "linear-gradient(135deg,#1f0036,#3d0063)", badge: "",
    ...
    },
    {
        ...
        price: 3190000, oldPrice: 3990000, rating: 4, reviews: 312,
        emoji: "🔊", gradient: "linear-gradient(135deg,#1a1200,#2d2000)", badge: "sale",
    ...
    },
    {
        ...
        price: 12990000, oldPrice: 14990000, rating: 5, reviews: 89,
        emoji: "⌚", gradient: "linear-gradient(135deg,#001a0d,#002d1a)", badge: "",
    ...
    },
    {
        ...
        price: 39990000, oldPrice: 0, rating: 5, reviews: 261,
        emoji: "💻", gradient: "linear-gradient(135deg,#141414,#242424)", badge: "new",
    ...
    },
    {
        ...
        price: 7290000, oldPrice: 7990000, rating: 5, reviews: 445,
        emoji: "🎧", gradient: "linear-gradient(135deg,#001535,#002a6e)", badge: "",
    ...
    },
    {
        ...
        price: 19990000, oldPrice: 22990000, rating: 4, reviews: 139,
        emoji: "📱", gradient: "linear-gradient(135deg,#1a0010,#3d0025)", badge: "hot",
    ...
    },
    {
        ...
        price: 1990000, oldPrice: 2490000, rating: 5, reviews: 203,
        emoji: "🔌", gradient: "linear-gradient(135deg,#002020,#004040)", badge: "sale",
    ...
    },
    {
        ...
        price: 62990000, oldPrice: 69990000, rating: 5, reviews: 67,
        emoji: "💻", gradient: "linear-gradient(135deg,#0d0d0d,#1a1a2e)", badge: "sale",
    ...
    },
    {
        ...
        price: 11990000, oldPrice: 0, rating: 5, reviews: 98,
        emoji: "🔊", gradient: "linear-gradient(135deg,#1a1500,#332900)", badge: "",
    ...
    },
    {
        ...
        price: 24990000, oldPrice: 0, rating: 4, reviews: 77,
        emoji: "📱", gradient: "linear-gradient(135deg,#001a35,#003370)", badge: "new",
    ...
    },
    {
        ...
        price: 29990000, oldPrice: 32990000, rating: 5, reviews: 154,
        emoji: "⌚", gradient: "linear-gradient(135deg,#0a001a,#1a0036)", badge: "",
    ...
    },
    {
        ...
        price: 48990000, oldPrice: 53990000, rating: 4, reviews: 41,
        emoji: "💻", gradient: "linear-gradient(135deg,#0a0a14,#161628)", badge: "sale",
    ...
    },
    {
        ...
        price: 41990000, oldPrice: 0, rating: 4, reviews: 33,
        emoji: "💻", gradient: "linear-gradient(135deg,#1c1c10,#332f1a)", badge: "",
    ...
    },
    {
        ...
        price: 54990000, oldPrice: 59990000, rating: 4, reviews: 28,
        emoji: "🎮", gradient: "linear-gradient(135deg,#1a0a0a,#330f0f)", badge: "sale",
    ...
    },
    {
        ...
        price: 109990000, oldPrice: 0, rating: 5, reviews: 19,
        emoji: "🎮", gradient: "linear-gradient(135deg,#1a0000,#330000)", badge: "hot",
    ...
    },
    {
        ...
        price: 42990000, oldPrice: 45990000, rating: 5, reviews: 61,
        emoji: "📱", gradient: "linear-gradient(135deg,#0c0c1a,#1a1a33)", badge: "sale",
    ...
    },
    {
        ...
        price: 7990000, oldPrice: 8990000, rating: 4, reviews: 215,
        emoji: "📱", gradient: "linear-gradient(135deg,#100018,#200030)", badge: "",
    ...
    },
    {
        ...
        price: 26990000, oldPrice: 0, rating: 4, reviews: 25,
        emoji: "📱", gradient: "linear-gradient(135deg,#000814,#001428)", badge: "new",
    ...
    },
    {
        ...
        price: 2390000, oldPrice: 2790000, rating: 4, reviews: 178,
        emoji: "🔊", gradient: "linear-gradient(135deg,#1a0f00,#332000)", badge: "",
    ...
    },
    {
        ...
        price: 9290000, oldPrice: 0, rating: 5, reviews: 142,
        emoji: "🎧", gradient: "linear-gradient(135deg,#0f0f0f,#1f1f1f)", badge: "hot",
    ...
    },
    {
        ...
        price: 3490000, oldPrice: 3990000, rating: 4, reviews: 87,
        emoji: "🔊", gradient: "linear-gradient(135deg,#1a1208,#332410)", badge: "sale",
    ...
    },
    {
        ...
        price: 8990000, oldPrice: 9990000, rating: 4, reviews: 96,
        emoji: "⌚", gradient: "linear-gradient(135deg,#101018,#1c1c2e)", badge: "",
    ...
    },
    {
        ...
        price: 3990000, oldPrice: 4490000, rating: 4, reviews: 112,
        emoji: "⌚", gradient: "linear-gradient(135deg,#1a0a18,#2d1230)", badge: "",
    ...
    },
    {
        ...
        price: 14990000, oldPrice: 0, rating: 5, reviews: 48,
        emoji: "⌚", gradient: "linear-gradient(135deg,#001018,#001c2e)", badge: "new",
    ...
    },
    {
        ...
        price: 1290000, oldPrice: 1590000, rating: 5, reviews: 267,
        emoji: "🔋", gradient: "linear-gradient(135deg,#001a1a,#003333)", badge: "sale",
    ...
    },
    {
        ...
        price: 2190000, oldPrice: 0, rating: 5, reviews: 198,
        emoji: "🖱️", gradient: "linear-gradient(135deg,#0a1018,#14202e)", badge: "",
    ...
    },
    {
        ...
        price: 2990000, oldPrice: 0, rating: 5, reviews: 134,
        emoji: "✏️", gradient: "linear-gradient(135deg,#101018,#1c1c2e)", badge: "new",
    ...
    },
    {
        ...
        price: 3290000, oldPrice: 3790000, rating: 5, reviews: 156,
        emoji: "💾", gradient: "linear-gradient(135deg,#001a2e,#002d52)", badge: "sale",
    ...
    },
    {
        ...
        price: 45990000, oldPrice: 49990000, rating: 4, reviews: 52,
        emoji: "💻", gradient: "linear-gradient(135deg,#0a0a0a,#1a1a1a)", badge: "sale",
    ...
    },
    {
        ...
        price: 5990000, oldPrice: 6990000, rating: 5, reviews: 231,
        emoji: "🎧", gradient: "linear-gradient(135deg,#0a0a18,#14142e)", badge: "sale",
...
/* Danh sách thương hiệu duy nhất, dùng để build bộ lọc động nếu cần */
